<?php
session_start();
if (!isset($_SESSION["login"]) || $_SESSION['role'] !== 'tendik') {
...
$tenaga_last_login = isset($_SESSION["tenaga_kependidikan_last_login"]) ? $_SESSION["tenaga_kependidikan_last_login"] : 'Belum Login';
?>
    ...
    function scanQRCode() {
      ...
      const qrCodeReader = () => {
        if (video.readyState === video.HAVE_ENOUGH_DATA) {
          ...
          if (code) {
            statusMessage.textContent = 'QR Code ditemukan: ' + code.data;
