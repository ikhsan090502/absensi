...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO tenaga_kependidikan (nipy, nama, jabatan, foto) VALUES ('$nipy', '$nama', '$jabatan', '$foto')";
...
<head>
  ...
  <title>Tambah Tenaga Kependidikan | UNDHA AUB</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid">
          <h1 class="h3 mb-4 text-gray-800">Tambah Tenaga Kependidikan</h1>

          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Tambah Tenaga Kependidikan</h6>
            </div>
            <div class="card-body">
              <form action="tambah_tendik.php" method="post" enctype="multipart/form-data">
                ...
                <a href="lihatendik.php" class="btn btn-secondary">Batal</a>
              </form>
            </div>
          </div>
        </div>
