...
<head>
  ...
  <title>Edit Absensi | UNDHA AUB</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">Ubah Absensi </h1>
            <form role="form" action="editabsensi.php?kelas=<?php echo $prodi;?>&nim=<?php echo $nim;?>" method="post" name="postform" enctype="multipart/form-data">
			<?php
            $sql="SELECT *,k.nama_kelas FROM mahasiswa s join kelas k on s.prodi=k.prodi WHERE nim='$nim'";
