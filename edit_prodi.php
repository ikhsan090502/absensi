...
<head>
  ...
  <title>Edit Program Studi | UNDHA AUB</title>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav align-items-center">
              <span class="mr-2 d-none d-lg-inline text-gray-600 medium">Terakhir Login : <span class="text-success"><?= $_SESSION["operator_user_last_login"] ?></span></span>
            </li>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form method="post" action="">
                ...
                <a href="lihatprodi.php" class="btn btn-secondary">Batal</a>
              </form>
            </div>
          </div>
        </div>
